...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    <a href="/tambahbarang" class="btn btn-warning">Tambah +</a>
        <div class="row g-3 align-items-center mt-2">
            <div class="col-md-5">
              <form action="/barang" method="GET">
                <input type="search" id="inputPassword6" name="search" class="form-control" aria-describedby="passwordHelpInline">
                <button type="submit" class="btn btn-primary ml-3 mt-3">Cari</button>
              </form>
            </div>
        </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $row->qty }}</td>
      <td>
            <a href="/show/{{ $row->id }}" class="btn btn-primary">Details</a>
